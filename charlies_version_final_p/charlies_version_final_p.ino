...
//   Serial.print("\tP:");     Serial.print(last_P, 2);
//   Serial.print("\tI:");     Serial.print(last_I, 2);
//   Serial.print("\tD:");     Serial.print(last_D, 2);
//   Serial.print("\tout:");   Serial.print(last_output, 2);
//   Serial.print("\tcorr:");  Serial.print(correction);
//   Serial.print("\tL:");     Serial.print(leftSpeed);
//   Serial.print("\tR:");     Serial.println(rightSpeed);
if (isPerpendicularLine())
{
  maxReadCount++;
}
else
...
void turnAtMaxSpeed()
{
  setMotor(left_pwm_pin, left_dir_pin, 255);
  setMotor(right_pwm_pin, right_dir_pin, -255);
  delay(290);
}
